                  ...
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3 className="font-semibold text-safari-green dark:text-warm-sand mb-1">
                            Email
                          </h3>
                    ...
                    {!submitSuccess ? (
                      <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Button
                          ...
                          className="w-full bg-sunset-orange hover:bg-sunset-orange/90 text-white font-medium py-3 transition-colors disabled:opacity-50"
                          size="lg"
                        >
        ...
        <section className="bg-warm-sand/10 dark:bg-gray-800 py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <div>
                <h3 className="font-semibold text-safari-green dark:text-warm-sand mb-2">
                  Local Expertise
                </h3>
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  Every tour is tailored to your interests, budget, and travel style 
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  We're committed to responsible tourism that supports wildlife 
              ...
              <div>
                ...
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  From planning to your return home, we provide continuous support 
                  to ensure your safari exceeds expectations.
                </p>
              </div>
            </div>
          </div>
